...
public class Catalog extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton2.setText("Search Course By ID");
        ...
        ArrayList<Course> arrcourse = CatalogController.viewCatalog();
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(courseoptions));
        this.selectedCourseID = courseoptions[0];
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        Course courseout = cc.searchCatalog(courseId);
        ...
        if(courseout != null){
          ...
          JOptionPane.showMessageDialog(this, "Unable to find Course !");
        }
    ...
    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
        // TODO add your handling code here:
        this.selectedCourseID = jComboBox1.getSelectedItem().toString();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(this.selectedCourseID == null){
           ...
           JOptionPane.showMessageDialog(this, "Unable to Select Course !");
 
        }
        CatalogController cc =  new CatalogController();
        Course courseout = cc.searchCatalog(this.selectedCourseID);
        System.out.println(courseout.courseID);
