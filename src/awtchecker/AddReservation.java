...
public class AddReservation extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String reservedDate =  jTextField4.getText();
        String reservationID = courseID+studentID;
        if(Reserve.createReserve(courseID, reservationID, studentID, reservedDate) == true){
           JOptionPane.showMessageDialog(this, "Reservation Added Succesfully");
           new Admin(this.curruser).setVisible(true);
           this.dispose();
